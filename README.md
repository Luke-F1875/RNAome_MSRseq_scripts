...
- bedRmod_format_converter.Rmd takes this compressed civ file and generates the nine bedRmodv2 files uploaded to the RNome project. This script only generates modifications for the most abundant isodecoders in each isoacceptor group in HEK293T cells as defined in Assari, M., B.J Chew, M.A. Bayat Tork, M. Sobczyk, C-Y. Zhu, H.A.V. Tran, D. Rudzka, W. Zhang, T. Pan: Decoding human tRNA modifications and crosstalk by enhanced single-read analysis, Genome Biol. in press (2026). 
